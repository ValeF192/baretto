...
$sql= "SELECT * FROM ordine inner join utente on utente_codice=utente.codice where stato='PRONTO'";//le righe dove la mail è uguale a qiuella inserita dall'utente
//echo $sql;
$resultm=$conn->query($sql);//oggetto che rappresenta la risposta del db
$conta=$resultm->num_rows;//utenti con quella mail
